...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--confidence', type=str, default=None, choices=['bayesian', 'dropout'], help='Produce confidence map')
        parser.add_argument('--inference_samples', type=int, default=10, help='Take mean of this number of samples')
        ...
        parser.add_argument('--netD', type=str, default='basic', choices=['basic', 'obelisk', 'n_layers', 'pixel', 'patch', 'tilestylegan2', 'stylegan2'], help='specify discriminator architecture. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        ...
        parser.add_argument('--load_seg', action='store_true', default=False, help='If set, load segmentation map')
