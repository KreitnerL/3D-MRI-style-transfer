    ...
    def set_input(self, input):
        ...
        if self.opt.phase == 'train':
            if self.opt.paired:
                ...
                self.real_A = self.spatialTransforms(self.real_A.flatten(0,1)).view(self.real_A.shape)
                self.real_B = self.spatialTransforms(self.real_B.flatten(0,1)).view(self.real_B.shape)
